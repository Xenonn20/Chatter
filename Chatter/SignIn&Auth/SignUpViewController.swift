...
class SignUpViewController: UIViewController {
    ...
    private let signUpButton = UIButton(title: "SignUp", titleColor: .white, backgroundColor: .buttonBlack())
    
    private let emailTextField = OnLineTextField(font: .avenir20())
    private let passwordTextField = OnLineTextField(font: .avenir20())
    private let confirmPasswordTextField = OnLineTextField(font: .avenir20())
...
struct SignUpControllerProvider: PreviewProvider {
    ...
    struct ContainerView: UIViewControllerRepresentable {
        ...
        func makeUIViewController(context: UIViewControllerRepresentableContext<SignUpControllerProvider.ContainerView>) -> SignUpViewController {
            return viewController
        }
        func updateUIViewController(_ uiViewController: SignUpControllerProvider.ContainerView.UIViewControllerType, context: UIViewControllerRepresentableContext<SignUpControllerProvider.ContainerView>) {
...
extension UIViewController {
    ...
    func showAlert(with title: String, and message: String, complection: @escaping() -> Void = { }) {
